...
#ifndef _QmitkMaxillofacialRegistrationWidget_H_INCLUDED
#define _QmitkMaxillofacialRegistrationWidget_H_INCLUDED

#include "ui_QmitkMaxillofacialRegistrationWidget.h"
 ...
 * \sa IGT
*/
class MitkIGTUI_EXPORT QmitkMaxillofacialRegistrationWidget : public QWidget
{
  Q_OBJECT // this is needed for all Qt objects that should have a MOC object (everything that derives from QObject)
public:

  QmitkMaxillofacialRegistrationWidget(QWidget* parent);
  virtual ~QmitkMaxillofacialRegistrationWidget();
...
protected:
  ...
  Ui::QmitkMaxillofacialRegistrationWidget* m_Controls;  ///< gui widget
  QmitkStdMultiWidget* m_MultiWidget;
  mitk::DataNode::Pointer m_ImageFiducialsNode;
  mitk::DataNode::Pointer m_TrackerFiducialsNode;

};
#endif // _QmitkMaxillofacialRegistrationWidget_H_INCLUDED
