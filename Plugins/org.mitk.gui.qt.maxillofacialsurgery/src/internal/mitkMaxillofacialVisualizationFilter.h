...
#ifndef MITKMAXILLOFACIALVISUALIZATIONFILTER_H_HEADER_INCLUDED_
#define MITKMAXILLOFACIALVISUALIZATIONFILTER_H_HEADER_INCLUDED_
...
namespace mitk {
  ...
  * \ingroup IGT
  */
  class MaxillofacialVisualizationFilter : public NavigationDataObjectVisualizationFilter
  {
  public:
	  mitkClassMacro(MaxillofacialVisualizationFilter, NavigationDataObjectVisualizationFilter);
  ...
  protected:
    ...
    * \brief Constructor
    **/
	  MaxillofacialVisualizationFilter();
...
#endif /* MITKMAXILLOFACIALVISUALIZATIONFILTER_H_HEADER_INCLUDED_ */
