...
mitk::MultiDeviceMonitoringVisualizationFilter::MultiDeviceMonitoringVisualizationFilter()
...
void mitk::MultiDeviceMonitoringVisualizationFilter::SetAssociatedSurfaceModel(unsigned int idx, BaseData* data)
{
...
*/
const mitk::BaseData* mitk::MultiDeviceMonitoringVisualizationFilter::GetAssociatedSurfaceModel(unsigned int idx)
{
...
void mitk::MultiDeviceMonitoringVisualizationFilter::SetRotationMode(RotationMode r)
{
	m_RotationMode = r;
}
...
*/
void mitk::MultiDeviceMonitoringVisualizationFilter::GenerateData()
{
...
* \brief Transfer the information from the input to the associated BaseData. This method changes with respect to the method of the base class.
*/
void mitk::MultiDeviceMonitoringVisualizationFilter::SetSurfaceTransform(int index, mitk::AffineTransform3D::Pointer surface_transform)
{
	m_SurfaceTransformList[index] = surface_transform;
}

mitk::AffineTransform3D::Pointer mitk::MultiDeviceMonitoringVisualizationFilter::GetSurfaceTransform(int index)
{
