...
#ifndef QmitkMITKIGTMultiDeviceMonitoringToolboxView_h
#define QmitkMITKIGTMultiDeviceMonitoringToolboxView_h

#include <berryISelectionListener.h>

#include <QmitkAbstractView.h>

#include "ui_QmitkMITKIGTMultiDeviceMonitoringToolboxViewControls.h"
...
#include "mitkMultiDevicemonitoringVisualizationFilter.h"
...
*/
class QmitkMITKIGTMultiDeviceMonitoringToolboxView : public QmitkAbstractView
{
  ...
  public:
	...
	QmitkMITKIGTMultiDeviceMonitoringToolboxView();
    virtual ~QmitkMITKIGTMultiDeviceMonitoringToolboxView();
  ...
  protected:
    ...
    Ui::QmitkMITKIGTMultiDevicemonitoringToolboxViewControls* m_Controls;
...
private:
	...
	MITKMaxillofacialTrackingLab *m_MultiDeviceMonitoringLab;
   ...
   std::vector<mitk::TrackingDeviceSource::Pointer> m_TrackingDeviceSourceVector; ///> member for the source of the IGT pipeline
   std::vector<mitk::MultiDeviceMonitoringVisualizationFilter::Pointer> m_ToolVisualizationFilterVector; ///> holds the tool visualization filter (second filter of the IGT pipeline)
   std::vector<mitk::TrackingDeviceData> m_TrackingDeviceDataVector; ///> stores the tracking device data as long as this is not handled by the tracking device configuration widget
   ...
   mitk::TrackingDeviceData TrackingDeviceData;
   ...
   /*members for the generation of a 3D model interpolating a pointset*/
   mitk::Plane::Pointer m_3DInterpolatedPlane;
   ...
   mitk::mitkDistanceMonitoring *m_DistMonitor;
   QmitkPlotWidget::DataVector m_VirtualTimeStamp;
   QmitkPlotWidget::DataVector m_Distance;
