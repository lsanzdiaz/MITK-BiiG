...
#ifndef MITKMultiDeviceMonitoringVISUALIZATIONFILTER_H_HEADER_INCLUDED_
#define MITKMultiDeviceMonitoringVISUALIZATIONFILTER_H_HEADER_INCLUDED_
...
namespace mitk {
  ...
  * \ingroup IGT
  */
  class MultiDeviceMonitoringVisualizationFilter : public NavigationDataObjectVisualizationFilter
  {
  public:
	  mitkClassMacro(MultiDeviceMonitoringVisualizationFilter, NavigationDataObjectVisualizationFilter);
  ...
  protected:
    ...
    * \brief Constructor
    **/
	  MultiDeviceMonitoringVisualizationFilter();
...
#endif /* MITKMultiDeviceMonitoringVISUALIZATIONFILTER_H_HEADER_INCLUDED_ */
