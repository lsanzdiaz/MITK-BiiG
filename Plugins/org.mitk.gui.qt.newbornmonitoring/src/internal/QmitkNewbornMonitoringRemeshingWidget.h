...
#ifndef QmitkNewBornmonitoringRemeshingWidget_h
#define QmitkNewBornmonitoringRemeshingWidget_h

#include "ui_QmitkNewBornmonitoringRemeshingWidget.h"
...
class QmitkNewBornmonitoringRemeshingWidget : public QWidget
{
  Q_OBJECT // this is needed for all Qt objects that should have a MOC object (everything that derives from QObject)
public:

  QmitkNewBornmonitoringRemeshingWidget(QWidget* parent);
  virtual ~QmitkNewBornmonitoringRemeshingWidget();
...
protected:
  ...
  Ui::QmitkNewBornmonitoringRemeshingWidget* m_Controls;  ///< gui widget
...
#endif // _QmitkNewbornmonitoringRemeshing_H_INCLUDED
