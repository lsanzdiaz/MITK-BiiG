...
#include "QmitkNewBornmonitoringRemeshingWidget.h"
...
/* VIEW MANAGEMENT */
QmitkNewBornmonitoringRemeshingWidget::QmitkNewBornmonitoringRemeshingWidget(QWidget* parent)
...
QmitkNewBornmonitoringRemeshingWidget::~QmitkNewBornmonitoringRemeshingWidget()
{
}

//#PUBLIC SETTER
void QmitkNewBornmonitoringRemeshingWidget::SetDataStorage(mitk::DataStorage::Pointer _DataStorage)
{
...
// #PUBLIC SETTER
void QmitkNewBornmonitoringRemeshingWidget::SetRenderer(vtkSmartPointer<vtkRenderWindow> _RenderWindow)
{
...
void QmitkNewBornmonitoringRemeshingWidget::CreateQtPartControl(QWidget* parent)
{
  if (!m_Controls)
  {
    // create GUI widgets
    m_Controls = new Ui::QmitkNewBornmonitoringRemeshingWidget;
...
void QmitkNewBornmonitoringRemeshingWidget::CreateConnections()
{
...
void QmitkNewBornmonitoringRemeshingWidget::EnableWidgets(bool enable)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnAdvancedSettingsButtonToggled(bool toggled)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnEdgeSplittingChanged(double edgeSplitting)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnGradationChanged(double gradation)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnMaxNumVerticesLineEditEditingFinished()
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnNumberOfVerticesChanged(int numVertices)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnOptimizationLevelChanged(int optimizationLevel)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnRemeshButtonClicked()
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnSelectedSurfaceChanged(const mitk::DataNode *node)
{
...
void QmitkNewBornmonitoringRemeshingWidget::OnSubsamplingChanged(int subsampling)
{
...
void QmitkNewBornmonitoringRemeshingWidget::SetNumberOfVertices(int minimum, int maximum, int step, int value)
{
...
void QmitkNewBornmonitoringRemeshingWidget::InitiateDistanceControl(mitk::DataNode::Pointer node)
{
	/*
...
Distance_Data* QmitkNewBornmonitoringRemeshingWidget::RealTimeControlOfDistance(mitk::Point3D ToolNavigationPosition)
{
