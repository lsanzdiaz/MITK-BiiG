...
// Qmitk
#include "QmitkMITKIGTNewBornMonitoringToolboxView.h"
...
const std::string QmitkMITKIGTNewBornMonitoringToolboxView::VIEW_ID = "org.mitk.views.QMITKMITKIGTNewBornMonitoringToolbox";

QmitkMITKIGTNewBornMonitoringToolboxView::QmitkMITKIGTNewBornMonitoringToolboxView()
	: QmitkAbstractView()
, m_Controls( 0 )
{
  ...
  m_NewBornMonitoringLab = new MITKMaxillofacialTrackingLab();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::CreateQtPartControl( QWidget *parent )
{
  // build up qt view, unless already done
  if ( !m_Controls )
  {
    // create GUI widgets from the Qt Designer's .ui file
    m_Controls = new Ui::QmitkMITKIGTNewbornmonitoringToolboxViewControls;
    ...
    m_toolStorage->SetName("NewBornMonitoringToolbox Default Storage");
...
void QmitkMITKIGTNewBornMonitoringToolboxView::LoadModel(std::string filename)
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnPreloadSettings(std::string filename)
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnLoadTools()
{
  //read in filename
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnResetTools()
{
  this->ReplaceCurrentToolStorage(mitk::NavigationToolStorage::New(GetDataStorage()),"NewBornMonitoringToolbox Default Storage");
  m_Controls->m_TrackingToolsStatusWidget->RemoveStatusLabels();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnConnect()
  {
...
if (this->m_toolStorage.IsNull())
  ...
  m_ToolVisualizationFilter = mitk::NewBornMonitoringVisualizationFilter::New();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnConnectAscensionMEDSAFE()
  {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnVirtualConnect()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnDisconnect()
  {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnStartTracking()
{
  try
    {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnStopTracking()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnPerformVirtualTracking(bool on)
{
	if (on)
	{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnTrackingDeviceChanged()
{
  mitk::TrackingDeviceType Type;
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnTrackingVolumeChanged(QString qstr)
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnShowTrackingVolumeChanged()
{
 if (m_Controls->m_ShowTrackingVolume->isChecked())
    {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnAutoDetectTools()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::CreateBundleWidgets(QWidget* parent)
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnSetupNavigation()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnSetupToolForTrajectoryControl()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::InitializeDistanceControl()
{
	mitk::DataStorage* ds = this->GetDataStorage();
	if (ds == NULL)
		return;
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnSetupTool()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnRegisterToolWithSurface(bool on)
{
	if (on)
	{
		m_Controls->m_RegistrationSurfaceComboBox->setEnabled(true);
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnSetAsReferenceFramework(bool on)
{
	if (on)
	{
		m_ReferenceFrameworkChecked = true;
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnAcceptToolData()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnCalculateRegistration()
{
	...
	m_MultipleDeviceMonitoringLab->CalculateRegistration(m_ImageFiducialsDataNode, m_TrackerFiducialsDataNode);

	m_Controls->m_RegistrationWidget->SetQualityDisplayText("FRE: " + QString::number(m_MultipleDeviceMonitoringLab->GetRegistrationFRE()) + " mm");

	vtkMatrix4x4 * matrix = m_MultipleDeviceMonitoringLab->GetVTKRegistrationTransform()->GetMatrix();
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::SaveSurfaceToToolRegistrationTransform()
{
	int index = m_Controls->m_TrackingDeviceSelectionWidget->GetSelectedToolID();
	...
	if (m_Controls->m_ToolToSurfaceRegistration->isChecked())
	{
		...
		m_MultipleDeviceMonitoringLab->GetITKRegistrationTransform()->GetInverse(matrix);
...

	{
		...
		m_GeneralRegistrationTransform = m_MultipleDeviceMonitoringLab->GetITKRegistrationTransform();
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnToolToSurfaceRegistration(bool on)
{
	m_Controls->m_GeneralRegistration->setChecked(!on);
}
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnGeneralRegistration(bool on)
{
	m_Controls->m_ToolToSurfaceRegistration->setChecked(!on);
}

void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnApplyRegistration(bool on)
{
	...
	if (on)
	{
		...
		{
			m_PSRecordingPointSet->GetGeometry()->Compose(m_MultipleDeviceMonitoringLab->GetITKRegistrationTransform());
		}
	...
	else //if off = disable the permanent registration
	{
		...
		if (m_PSRecordingPointSet.IsNotNull())
		{
			m_PSRecordingPointSet->GetGeometry()->Compose(m_MultipleDeviceMonitoringLab->GetITKRegistrationTransformInverse());
		}
		...
		{
			m_DistanceLinePointSet->GetGeometry()->Compose(m_MultipleDeviceMonitoringLab->GetITKRegistrationTransformInverse());
		}
	}
}

bool QmitkMITKIGTMultipleDeviceMonitoringToolboxView::CheckRegistrationInitialization()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::InitializeRegistration()
{
	mitk::DataStorage* ds = this->GetDataStorage();
	if (ds == NULL)
		return;
...
*/
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnAddRegistrationTrackingFiducial()
{
	...
	nd = m_TrackingDeviceSource->GetOutput(2);
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::MessageBox(std::string s)
  {
  QMessageBox msgBox;
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::UpdateTrackingTimer()
  {
	bool movement = false;
	double min_dist;
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnChooseSettingsFileClicked()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnPreloadSettingsClicked()
{
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnChooseFileClicked()
  {
...
void QmitkMITKIGTMultipleDeviceMonitoringToolboxView::OnSaveCurrentSettingsClicked()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnChooseTransformFileNameClicked()
{
	QDir currentPath = QFileInfo(m_Controls->m_TransformFileName->text()).dir();
// if no path was selected (QDir would select current working dir then) or the
	// selected path does not exist -> use home directory
	...
	vtkMatrix4x4 * matrix = m_NewBornMonitoringLab->GetVTKRegistrationTransform()->GetMatrix();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnToggleFileExtension(QLineEdit *filename)
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::StartLogging()
  {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::StopLogging()
  {
  if (m_logging)
    {
    //update label
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnAddSingleTool()
  {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnAddSingleToolFinished()
  {
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnAddSingleToolCanceled()
  {
  m_Controls->m_TrackingToolsWidget->setCurrentIndex(0);
...
void QmitkMITKIGTNewBornMonitoringToolboxView::GlobalReinit()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::DisableLoggingButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::EnableLoggingButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::DisableOptionsButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::EnableOptionsButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::EnableTrackingConfigurationButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::DisableTrackingConfigurationButtons()
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::ReplaceCurrentToolStorage(mitk::NavigationToolStorage::Pointer newStorage, std::string newStorageName)
{
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnPointSetRecording(bool record)
{
	mitk::DataStorage* ds = this->GetDataStorage();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnDistanceControl(bool distance_control)
...
void QmitkMITKIGTNewBornMonitoringToolboxView::OnInterpolate3DModel()
{
	mitk::DataStorage* ds = this->GetDataStorage();
	mitk::DataNode::Pointer dn = mitk::DataNode::New();
...
void QmitkMITKIGTNewBornMonitoringToolboxView::SetFocus()
{
	//m_Controls->m_UseAsPointerButton->setFocus();
}

bool QmitkMITKIGTNewBornMonitoringToolboxView::IsTransformDifferenceHigh(mitk::NavigationData::Pointer transformA, mitk::NavigationData::Pointer transformB, double euclideanDistanceThreshold, double angularDifferenceThreshold)
{
