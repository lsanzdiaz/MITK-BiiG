...
#ifndef QmitkMITKIGTNewBornMonitoringToolboxView_h
#define QmitkMITKIGTNewBornMonitoringToolboxView_h

#include <berryISelectionListener.h>

#include <QmitkAbstractView.h>

#include "ui_QmitkMITKIGTNewBornMonitoringToolboxViewControls.h"
...
*/
class QmitkMITKIGTNewBornMonitoringToolboxView : public QmitkAbstractView
{
  ...
  public:
	...
	QmitkMITKIGTNewBornMonitoringToolboxView();
    virtual ~QmitkMITKIGTNewBornMonitoringToolboxView();
  ...
  protected:
    ...
    Ui::QmitkMITKIGTNewbornmonitoringToolboxViewControls* m_Controls;
...
private:
	...
	MITKMaxillofacialTrackingLab *m_NewBornMonitoringLab;
   ...
   mitk::NewBornMonitoringVisualizationFilter::Pointer m_ToolVisualizationFilter; ///> holds the tool visualization filter (second filter of the IGT pipeline)
